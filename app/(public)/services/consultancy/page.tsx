  ...
  return (
    <>
      <SectionContainer>
        ...
        <h1 className="mt-3 text-4xl font-semibold">Real Estate Consultancy</h1>
        <p className="mt-4 max-w-2xl text-muted">Market intelligence and investment advisory for acquisition, repositioning, and growth.</p>
      </SectionContainer>
